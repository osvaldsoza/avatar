package com.github.osvaldsoza.infrastructure.resources;

import com.github.osvaldsoza.application.ApplicationService;
...
public class CustomerResource {
    ...
    public void persistenceProfilePhoto(@PathParam("id") String id,
